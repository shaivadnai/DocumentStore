...
public class DocumentStoreImpl3Test {
...
or returned in any form as the result of any “get” or “search” request, or an action on it is undone via any call to either of the DocumentStore.undo methods.
    ...
    public void stage4TestMaxDocCountViaPut() {
        ...
        store.putDocument(new ByteArrayInputStream(this.pdfData3), this.uri3, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
        //uri1 and uri2 should both be written to disk, having been pushed out by 3 and 4 
        assertFalse(pm.isOnDisk(this.uri4));
        assertFalse(pm.isOnDisk(this.uri3));
        assertTrue(pm.isOnDisk(this.uri1));
        assertTrue(pm.isOnDisk(this.uri2));
        assertNotNull("uri1 should've been pushed out of memory when uri3 was inserted",store.getDocument(this.uri1));
        assertNotNull("uri2 should've been pushed out of memory when uri4 was inserted",store.getDocument(this.uri2));
    ...
    public void stage4TestMaxDocCountViaSearch() {
        ...
        assertFalse(pm.isOnDisk(this.uri4));
        assertTrue(pm.isOnDisk(this.uri2));
        assertFalse(pm.isOnDisk(this.uri1));
        assertFalse(pm.isOnDisk(this.uri3));
    }
    ...
    public void stage4TestUndoAfterMaxDocCount() {
        ...
        assertNotNull("uri3 should still be in memory",store.getDocument(this.uri3));
        assertFalse(pm.isOnDisk(this.uri1));
        assertFalse(pm.isOnDisk(this.uri2));
        assertFalse(pm.isOnDisk(this.uri3));
    ...
    public void stage4TestMaxDocBytesViaSearch() {
        ...
        //"touch" uri1 via a search
        store.search("doc1");
        //add doc4, doc2 should be pushed out to disk, not doc1 
        store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
        assertNotNull("uri1 should still be in memory",store.getDocument(this.uri1));
        assertNotNull("uri3 should still be in memory",store.getDocument(this.uri3));
        assertNotNull("uri4 should still be in memory",store.getDocument(this.uri4));
    ...
    public void stage4TestUndoAfterMaxBytes() {
        ...
        assertFalse(pm.isOnDisk(this.uri2));
        assertFalse(pm.isOnDisk(this.uri3));
        //add doc4, doc1 should be written to disk
        store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
        assertNotNull("uri2 should still be in memory",store.getDocument(this.uri2));
        assertNotNull("uri3 should still be in memory",store.getDocument(this.uri3));
        assertNotNull("uri4 should still be in memory",store.getDocument(this.uri4));
    ...
    public void stage4TestMaxDocsWhenDoubleMaxViaPut() {
        ...
        store.putDocument(new ByteArrayInputStream(this.pdfData3), this.uri3, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
        //uri1 and uri2 should both written to disk, having been pushed out by 3 and 4 
        assertNotNull("uri1 should've been pushed out of memory when uri3 was inserted",store.getDocument(this.uri1));
        assertNotNull("uri2 should've been pushed out of memory when uri4 was inserted",store.getDocument(this.uri2));
        assertNotNull("uri3 should still be in memory",store.getDocument(this.uri3));
        assertNotNull("uri4 should still be in memory",store.getDocument(this.uri4));
    ...
    @Test
    public void variedBaseDirs() {
        DocumentStoreImpl store = new DocumentStoreImpl(new File("C:/Users/sv126/VadnaiCharles/DataStructures/project/stage5/src/test/jsontests"));
        DocumentPersistenceManager pm = new DocumentPersistenceManager(new File("C:/Users/sv126/VadnaiCharles/DataStructures/project/stage5/src/test/jsontests"));
        store.setMaxDocumentBytes(this.bytes1*10);
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData2), this.uri2, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void putOverrideOnDiskUndo(){
            DocumentStore store = new DocumentStoreImpl();
            store.setMaxDocumentCount(1);
            store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
            store.putDocument(new ByteArrayInputStream(this.pdfData2), this.uri2, DocumentStore.DocumentFormat.PDF);
            store.putDocument(new ByteArrayInputStream(this.pdfData3), this.uri1, DocumentStore.DocumentFormat.PDF);
            assertTrue(this.pdfTxt3.equals(store.getDocumentAsTxt(this.uri1)));
            store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
            store.undo(this.uri1);
            assertTrue(this.pdfTxt1.equals(store.getDocumentAsTxt(this.uri1)));
    }

    @Test
    public void testHeapElementsHeapify(){
        DocumentStore store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        DocumentPersistenceManager pm = new DocumentPersistenceManager(null);
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1,DocumentStore.DocumentFormat.TXT);
